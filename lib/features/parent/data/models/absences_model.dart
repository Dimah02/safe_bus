...
List<Absences> absencesFromJson(String str) => List<Absences>.from(json.decode(str).map((x) => Absences.fromJson(x)));

String absencesToJson(List<Absences> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
